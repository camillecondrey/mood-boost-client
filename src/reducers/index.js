	...
	if (action.type === ANGER) {
        ...
        state = Object.assign({}, initialState, {
            read: [`"Relaxation means releasing all concern and tension and letting the natural 
                    ...
                    connect with your own being.`, `Take a minute to think about everything you're grateful for. Write it down on a list 
                    when you're feeling blue and it will remind you what you have to be happy about.`, ],
            watch: {
        ...
        state = Object.assign({}, initialState, {
            read: [`"May the ocean of your soul be reminiscent of the moon, one beautiful receding tide after another
                   ...
                   with your favorite book. Treat yourself. Romance, by definition, is a quality or feeling of mystery, excitement, and 
                   remoteness from everyday life, so let yourself escape the everyday and seek what makes you excited.`],
            watch: {
                src: ["http://gph.is/2lEPgHH"]
            },
            listen: {
        ...
        state = Object.assign({}, initialState, {
            ...
            watch: {
                intro: "Stretching is a rejuvinating activity that can increase your energy levels. Follow along to these simple stretches that release muscle tension and give your mood an energy boost.",
                src: 
            ...
            listen: {
                spotify: "https://open.spotify.com/embed/user/spotifyusa/playlist/3uz1GV5nKYM4XPhBJagqgy"},
